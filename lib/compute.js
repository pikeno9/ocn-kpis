...
function build(sheets, referenceDate) {
  ...
  // Received Fleet acumulado começa em MARÇO (=0 recebido), depois Abr..Dez
  const acumRecebido = {};
  ...
  return {
    ...
    acumulado: { labels: C.esperado.acumLabels, recebido: acumRecebido, esperado: C.esperado.acumulado },
