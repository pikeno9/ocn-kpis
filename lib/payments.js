...
function build(matrizData, clientesRows, refDate) {
  ...
  return {
    weeks: dates.map((k) => {
      ...
      return {
        date: k,
        counts: { onTime: w.onTime.length, late1: w.late1.length, late2: w.late2.length, recovered: w.recovered.length, returned: w.returned.length },
        names: w,
      };
    }),
  };
...
module.exports = { fetchMatriz, build };
