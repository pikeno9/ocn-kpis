...
async function fetchAllTabs(tabs) {
  const [importData, ocorrencias, clientes, rh, leads, time, funil, leadsInDrive, perfInDrive, perfInDriveData, rev, multasCons, carrosEsperados] = await Promise.all([
  ...
  return { importData, ocorrencias, clientes, rh, leads, time, funil, leadsInDrive, perfInDrive, perfInDriveData, rev, multasCons, carrosEsperados };
}
